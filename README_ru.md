...
* **Полноэкранный Kiosk-режим:** Полностью убирает рамки и декорации окон с помощью Matchbox Window Manager для максимального погружения в код.
...
* **Оконный менеджер:** Matchbox Window Manager (нативный Kiosk-режим)
